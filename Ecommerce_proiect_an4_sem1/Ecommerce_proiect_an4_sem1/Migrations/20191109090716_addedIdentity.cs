        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    product_id = table.Column<int>(nullable: false),
                    remaining_stock = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Card_Number = table.Column<string>(unicode: false, maxLength: 19, nullable: false),
                    role_id = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    has_been_placed = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stock_Entry_product_id",
                table: "Stock_Entry",
                column: "product_id");
